...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        if ($this->config->requireActivation !== null) {
            ...
            // Success!
            return redirect()->to('/manajemenakun')->with('message', lang('Auth.activationSuccess'));
        }

        // Success!
        return redirect()->to('/manajemenakun')->with('message', lang('Auth.registerSuccess'));
    }
    ...
    public function attemptReset()
    {
        ...
        return redirect()->route('/')->with('message', lang('Auth.resetSuccess'));
    }
