    ...
    <div class="container-fluid">
        <section class="d-flex justify-content-center" style="margin-top: 300px;">
            <main class="d-flex justify-content-center">
                <div class="card w-100 shadow-lg" style="margin-bottom: 100px;">
                    <h2 class="card-header d-flex justify-content-center" style="background-color: white; color: #002147"><b><?=lang('Auth.resetYourPassword')?></b></h2>
                    ...
                    <div class="card-body">
                        ...
                        <center><button type="submit" class="btn btn-success w-75" style="background-color: #002147;">Atur Ulang Kata Sandi</button></center>
                    </form>
